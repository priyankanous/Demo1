  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route path="/reports/businesstypewiseview" component={Reports.BusinessType} />
        <Route path="/settings/account" component={Settings.Account} />
        <Route path="/settings/opportunity" component={Settings.Opportunity} />
        <Route path="/settings/role-user-permission" component={Settings.RoleUserPermission} />
        <Route path="/settings/explicit-permission" component={Settings.ExplicitPermission} />
        <Route path="/settings/annual-target-entry" component={Settings.AnnualTargetEntry} />
