  ...
  return (
    <div>
      <BaseComponent
        ...
        firstHeader="Name of financial year"
        secondHeader="Custom name of financial year"
        thirdHeader="Finanical year starting from"
        fourthHeader="Financial Year Ending On"
        data={data}
        Tr={Tr}
        setIsOpen={setIsOpen}
      />
